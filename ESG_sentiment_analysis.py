...
nlp = spacy.load(r'C:\Users\William\Anaconda3\Lib\site-packages\en_core_web_md\en_core_web_md-2.2.0')
...
def docuanalyze(filename):
    ...
    curDir = os.getcwd()
    os.chdir(wrkDir)  #check: change to the current working directory          
    for parent, dirnames, filenames in os.walk(curDir):  
        for filename in filenames:
            basename, extname = os.path.splitext(filename)
            if(cmp(extname, '.txt') == 0):
                ...
                print('Total Discussion of Environmental Issues is: ' + total_enviro_discuss)
                print('Total Environmental Points is: ' + total_enviro_points + ' points')
                print('Total Environmental Sentiment is: ' + enviro_sentiment)
                ...
                print('Total Discussion of Social Issues is: ' + total_social_discuss)
                print('Total Social Points is: ' + total_social_points + ' points')
                print('Total Environmental Sentiment is: ' + social_sentiment)
                ...
                print('Total Discussion of Governance Issues is: ' + total_govern_discuss)
                print('Total Governance Points is: ' + total_govern_points + ' points')
                print('Total Governance Sentiment is: ' + govern_sentiment)
                ...
                print('The total ESG points for ' + str(filename) + 'are: ' + total_ESG_points)
